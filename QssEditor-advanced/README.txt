...
this project base on QssEditor，I modify UI,add some other widgets,and also add enable or disable state to make it more useful.

Author: xusongjie <376186432@qq.com>
License: GNU GPLv3+ (see LICENSE.txt),
		 QssEditor parts are under GNU GPLv3+,
