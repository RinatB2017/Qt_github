...
#include <memory>
#include "../../../../../private/RIP/Games/QtMario_Original Code/src/view.h"
...
QT_MOC_LITERAL(1, 5, 12), // "sceneChanged"
QT_MOC_LITERAL(2, 18, 0) // ""

    },
    "View\0sceneChanged\0"
};
...
void View::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (View::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&View::sceneChanged)) {
                *result = 0;
                return;
            }
        }
